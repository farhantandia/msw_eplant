...
class AuthService {
  ...
  static Set<String> get _defaultPasswords => EnvConfig.defaultPasswords;

  static String _defaultForScope(String scope) {
    switch (scope.toLowerCase()) {
      case 'admin':
        return EnvConfig.defaultAdminPassword;
      case 'operation':
        return EnvConfig.defaultOperatorPassword;
      case 'maintenance':
        return EnvConfig.defaultMaintenancePassword;
      case 'okr_editor':
        return EnvConfig.defaultOkrPassword;
      default:
        return EnvConfig.defaultGeneralPassword;
    }
  }
  ...
  static Future<bool> verifyPasswordScope(String scope, String password) async {
    ...
    return password == _defaultForScope(scope) || _defaultPasswords.contains(password);
  }
