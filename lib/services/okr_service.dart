...
class OkrService {
  ...
  Future<void> reorderObjectives(int oldIndex, int newIndex) async {
    ...
    _addChangelog('Objective order updated');
  }
  ...
  Future<void> deleteKeyResult(String objId, String krId) async {
    ...
    _addChangelog('Delete Key Result');
  }
      ...
      Objective(
        ...
        keyResults: [
          ...
          KeyResult(
            ...
            description: 'Achieve SAIDI \u22641.0 hrs and SAIFI \u22641.0 events',
            target: '\u22641.0', targetUnit: 'hrs/freq',
          ...
          KeyResult(
            ...
            target: '3', targetUnit: 'initiatives',
      ...
      Objective(
        ...
        keyResults: [
          ...
          KeyResult(
            ...
            target: '0', targetUnit: 'each category',
            type: KrType.binary,
          ...
          KeyResult(
            ...
            target: '5', targetUnit: 'regulations',
