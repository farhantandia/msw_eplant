...
import 'package:msw_eplant/pages/okr/okr_editor_page.dart';
import 'package:msw_eplant/pages/settings/set_password_page.dart';
              ...
              children: [
                _buildMenuList([
                  _AdminMenuItemData(
                    ...
                    label: 'OKR Editor',
                    subtitle: 'Manage OKR structure & progress',
                  ...
                  _AdminMenuItemData(
                    ...
                    label: 'Set Password',
                    subtitle: 'Change login passwords for all roles',
            ...
            return AlertDialog(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Icon(
                          label.contains('Password') ? Icons.key_outlined : Icons.track_changes_outlined,
                          size: 22,
                          color: color,
                        ),
                      ),
                    ...
                    Text(
                      '$label Password',
                      style: const TextStyle(fontSize: AppTheme.fs16, fontWeight: FontWeight.w700, color: AppColors.text),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.lock_outline_rounded, size: 18, color: AppColors.textDim),
                          const SizedBox(width: 8),
                          Expanded(
                            child: TextField(
                              controller: ctl,
                              obscureText: true,
                              style: const TextStyle(color: AppColors.text, fontSize: AppTheme.fs14),
                              ...
                              onSubmitted: (_) async {
                                ...
                                if (ctx.mounted) {
                                  if (ok) {
                                    ...
                                    setDlgState(() => error = 'Incorrect password');
                                  }
                                }
                              },
                            ),
                    ...
                    if (error != null) ...[
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 6),
                          Text(error!, style: const TextStyle(fontSize: AppTheme.fs14, color: AppColors.danger)),
                        ],
                      ),
                    ],
                  ],
              ...
              actions: [
                TextButton(
                  ...
                  child: const Text(
                    'Cancel',
                    style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w600, color: AppColors.textSub),
                  ),
                ),
                ElevatedButton(
                  onPressed: () async {
                  ...
                  child: const Text('Unlock', style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w800)),
                ),
              ],
            );
          },
