              ...
              children: [
                ...
                _buildMenuList([
                  _MenuItemData(
                    ...
                    label: 'Number Format',
                    subtitle: 'Decimals: $_decimalPlaces ${_decimalPlaces == 1 ? "digit" : "digits"}',
                    color: AppColors.general,
                    onTap: _openNumberFormat,
                  ),
                  _MenuItemData(
                    icon: Icons.notifications_outlined,
                    label: 'Notifications',
                    subtitle: _notifEnabled ? 'Daily reminder 08:00 WITA active' : 'Daily reminder disabled',
        ...
        children: [
          ...
          const Column(
            ...
            children: [
              ...
              Text('MSW ePlant v2.0.0', style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub)),
            ],
          ),
        ],
      ),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(child: Icon(i.icon, size: 18, color: i.color)),
                  ),
                      ...
                      children: [
                        ...
                        if (i.subtitle != null)
                          Padding(
                            ...
                            child: Text(i.subtitle!, style: const TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub)),
                          ),
                      ],
                    ),
                  ),
                  if (i.isProtected)
                    Container(
                      ...
                      child: const Text(
                        'PASSWORD',
                        style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w700, color: AppColors.maintenance),
                      ),
                    ),
        ...
        children: [
          ...
          const Column(
            ...
            children: [
              Text(
                'MSW ePlant',
                style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w800, color: AppColors.text),
              ),
              Text(
                'v3.0.0 \u00B7 Build: Jul 2026',
        ...
        child: const Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w700, color: AppColors.danger),
            ),
          ],
        ),
      ),
            ...
            return SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  const Text(
                    'Number Format',
                    style: TextStyle(fontSize: AppTheme.fs16, fontWeight: FontWeight.w700, color: AppColors.text),
                  ),
                  const SizedBox(height: 4),
                  const Text('Select decimal places', style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub)),
                  const SizedBox(height: 16),
                  ...List.generate(4, (i) {
                    final val = i;
                          ...
                          children: [
                            ...
                            Text(
                              val == 0
                                  ...
                                  ? '1 decimal (e.g. 10.5)'
                                  : val == 2
                                  ? '2 decimals (e.g. 10.50)'
                                  : '3 decimals (e.g. 10.500)',
                              style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub),
                            ),
                            const Spacer(),
            ...
            return SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    'Configure notifications and daily reminders',
                    style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub),
                  ),
                  const SizedBox(height: 16),
                  _notifTile(
                    ...
                    subtitle: _notifEnabled ? 'Enabled' : 'Disabled',
                    trailing: Switch(
                      value: _notifEnabled,
                    ...
                    onTap: () async {
                      ...
                      if (ctx.mounted) {
                        ScaffoldMessenger.of(
                          ctx,
                        ).showSnackBar(const SnackBar(content: Text('Notification permission updated')));
                      }
                    },
                    child: _notifTile(
                      icon: Icons.shield_outlined,
                      title: 'Notification Permissions',
                      subtitle: 'Ensure notification permission is granted',
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (ctx.mounted) {
                        ScaffoldMessenger.of(
                          ctx,
                        ).showSnackBar(const SnackBar(content: Text('Test notification will be sent in 3 minutes')));
                      }
                      Navigator.pop(ctx);
                    },
                    child: _notifTile(
                      ...
                      subtitle: 'Receive notification in 3 minutes',
                      trailing: const Icon(Icons.chevron_right, color: AppColors.textDim),
                    ),
                  ),
                ],
