...
class _NphrPageState extends State<NphrPage> {
  ...
  DatabaseReference? _boiler1Ref;
  DatabaseReference? _boiler2Ref;
  ...
  void _fetchData() {
    try {
      ...
      _boiler1Ref = rtdb.ref("excel_data/table1");
      _boiler2Ref = rtdb.ref("excel_data/table2");
      ...
      _boiler2Sub = _boiler2Ref?.onValue.listen((event) {
        ...
        if (snapshot is List && snapshot.length > 1 && snapshot.last is List) {
          ...
          if (mounted) {
            setState(() {
              load2 = double.tryParse(lastRow[1].toString())?.clamp(0, double.infinity) ?? 0;
            });
          }
        }
      });
    } catch (e) {
      debugPrint("Firebase RTDB streams in NphrPage skipped: $e");
    }
  }
 ...
 Widget _buildLegendItem(Color color, String text, {bool isDot = false}) {
    return Row(
      ...
      children: [
        ...
        Text(text, style: const TextStyle(fontSize: AppTheme.fs14)),
      ],
    );
  }
  @override
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Last update: $formattedDate", style: const TextStyle(fontSize: AppTheme.fs14, color: Colors.grey)),
                  ),
                ],
              ),
            ],
              ...
              leftTitles: AxisTitles(
                ...
                sideTitles: SideTitles(
                  ...
                  getTitlesWidget: (value, meta) => Text(
                    ...
                    style: const TextStyle(fontSize: AppTheme.fs14),
                  ),
                ),
              ),
