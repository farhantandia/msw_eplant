      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: const Text('Use Code', style: TextStyle(fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        'Point camera at item Barcode or QR Code',
                        style: TextStyle(color: AppColors.text, fontSize: AppTheme.fs13),
                      ),
                    ],
                  ),
                ),
                ...
                OutlinedButton.icon(
                  ...
                  label: const Text('Manual Code Input', style: TextStyle(fontSize: AppTheme.fs14)),
                ),
              ],
            ),
          ),
