            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      _buildDetailRow('D365 Journal No', req.d365JournalNo ?? '-'),
                      _buildDetailRow('Status', req.status),
                      _buildDetailRow('Warehouse', req.warehouseLocation),
                      ...
                      _buildDetailRow('Requester', req.submittedBy),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Item No: ${line.itemNumber}',
                                  style: const TextStyle(
                                      color: AppColors.textSub, fontSize: AppTheme.fs11),
                                ),
                              ],
                            ),
                          ),
              ...
              child: Column(
                ...
                children: [
                            ...
                            children: [
                              ...
                              Text(
                                _d365User != null
                                    ...
                                    : 'Login required when submitting material issue.',
                                style: const TextStyle(
                                    color: AppColors.textSub, fontSize: AppTheme.fs11),
                              ),
                            ],
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Issue warehouse material by entering item number or scanning barcode, then register to D365.',
                          style: TextStyle(
                  ...
                  _buildActionCard(
                    ...
                    subtitle: 'Search items by name to check item number & stock',
                      ...
                      child: const Center(
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text(
                              'No material issue transactions yet',
                              style: TextStyle(
                                  color: AppColors.textSub, fontSize: AppTheme.fs13),
                            ),
                          ],
                        ),
                      ),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search item name or item number...',
                hintStyle:
                    const TextStyle(color: AppColors.textDim, fontSize: AppTheme.fs12),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          const Text(
                            'Type item name (e.g. bearing, valve, oil) or item number to search availability in D365.',
