...
class _OkrPageState extends State<OkrPage> {
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              const Text('Company Objectives & Key Results', style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub)),
            ],
          ),
          const Spacer(),
          Container(
            ...
            child: const Center(child: Icon(Icons.track_changes_outlined, size: 16, color: AppColors.pink)),
          ),
        ],
      ),
    );
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w900, color: AppColors.text),
                ),
              ],
            ),
          ),
          Column(
            ...
            children: [
              const Text('Overall Progress', style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub)),
              ...
              Text(
                ...
                style: const TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w800, color: AppColors.general),
              ),
            ],
          ),
        ],
  ...
  Widget _buildKrItem(KeyResult kr, Color objColor) {
    ...
    if (kr.type == KrType.qualitative) {
      ...
      actualText = 'Zero incident YTD (Achieved)';
    } else {
      actualText =
          'Actual: ${kr.actualValue} \u00B7 Target: ${kr.target}${kr.targetUnit.isNotEmpty ? ' ${kr.targetUnit}' : ''}';
    }
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    kr.label,
                    style: const TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w700, color: AppColors.textSub),
                  ),
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: Text(kr.description, style: const TextStyle(fontSize: AppTheme.fs14, color: AppColors.text, height: 1.4)),
              ),
            ],
          ),
            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: AppTheme.fs14, fontWeight: FontWeight.w700, color: barColor),
                ),
                const SizedBox(width: 6),
                Container(
          ...
          Padding(
            ...
            child: Text(
              actualText,
              style: const TextStyle(fontSize: AppTheme.fs14, color: AppColors.textSub, fontStyle: FontStyle.italic),
            ),
          ),
        ],
      ),
  ...
  Widget _buildLastUpdate() {
    return const Padding(
      ...
      child: Text(
        'Last updated: 14 Jul 2026, 08:30 WITA \u00B7 by MSW Admin',
        textAlign: TextAlign.center,
        style: TextStyle(fontSize: AppTheme.fs14, color: AppColors.textDim),
      ),
    );
  }
}
