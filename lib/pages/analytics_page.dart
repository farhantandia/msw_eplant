              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(fontSize: AppTheme.fs16, color: Colors.grey[400]),
                  ),
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            ...entry.value.map((param) => ListTile(
                                  ...
                                  title: Text(
                                    param.columnName,
                                    style: const TextStyle(color: Colors.white, fontSize: AppTheme.fs12),
                                  ),
      ...
      return Container(
        ...
        child: const Center(
          child: Text(
            ...
            style: TextStyle(color: Colors.grey, fontSize: AppTheme.fs16),
          ),
        ),
      );
    }
      ...
      children: _selectedParams.asMap().entries.map((entry) {
        ...
        return Chip(
          avatar: CircleAvatar(
            ...
            radius: 7,
                child: Text(axisLabel, style: const TextStyle(fontSize: AppTheme.fs22, fontWeight: FontWeight.bold, color: Colors.black)),
          ),
          label: Text(
            sp.param.displayName,
            style: const TextStyle(fontSize: AppTheme.fs12, color: Colors.white),
          ),
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) => SideTitleWidget(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: AppTheme.fs12, color: colorPalette[0]),
                  ),
                ),
              ),
            ),
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) => SideTitleWidget(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: AppTheme.fs12, color: colorPalette.length > 2 ? colorPalette[2] : Colors.grey),
                  ),
                ),
              ),
            ),
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  return SideTitleWidget(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(fontSize: AppTheme.fs16, color: Colors.grey),
                    ),
                  );
                },
              ),
