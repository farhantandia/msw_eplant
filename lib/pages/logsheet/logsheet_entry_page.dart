...
class _LogsheetEntryPageState extends State<LogsheetEntryPage> {
  ...
  Future<void> _loadOperatorList() async {
    try {
      ...
      setState(() {
        _operatorList = ["- Select -", ...ops, "Other..."];
        _supervisorList = ["- Select -", ...sups, "Other..."];
      });
    } catch (_) {}
  }
  ...
  Future<void> _save() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          "Save data for slot $_selectedSlot to Google Sheets?",
    ...
    if (mounted) {
      ...
      if (err == null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Failed to save data: $err"),
        ...
        children: [
          _buildCard(
            child: Column(
              ...
              children: [
                ...
                _buildSectionLabel("SHIFT (automatic)"),
                const SizedBox(height: 8),
                Container(
          ...
          _buildCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildSectionLabel("OPERATOR NAME"),
                const SizedBox(height: 8),
                _buildDropdown(
                  value: _otherOperator ? "Other..." : _operatorCtrl.text,
                  items: _operatorList,
                  onChanged: (v) {
                    if (v == "Other...") {
                      setState(() {
                ...
                if (_otherOperator) ...[
                  const SizedBox(height: 8),
                  _buildTextField(_operatorCtrl, "Enter operator name"),
                ],
                const SizedBox(height: 16),
                _buildSectionLabel("SUPERVISOR NAME"),
                const SizedBox(height: 8),
                _buildDropdown(
                ...
                if (_otherSupervisor) ...[
                  const SizedBox(height: 8),
                  _buildTextField(_supervisorCtrl, "Enter supervisor name"),
                ],
              ],
            ),
          ),
          ...
          ElevatedButton(
            ...
            child: const Text("Proceed to Data Input",
                style: TextStyle(
                    fontSize: AppTheme.fs14, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text("Generate Random Data",
                      style: TextStyle(fontSize: AppTheme.fs14)),
                  onPressed: _generateDummyData,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _saving
                      ...
                      : Text(
                          "Save Data for Slot $_selectedSlot",
                          style: const TextStyle(
                              fontSize: AppTheme.fs14, fontWeight: FontWeight.bold),
                        ),
                ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          Text("Time Slot: ",
              style: TextStyle(color: Colors.grey[400], fontSize: AppTheme.fs14)),
      ...
      child: Container(
        ...
        child: ExpansionTile(
          ...
          subtitle: Text("${group.fields.length} parameter",
              style: TextStyle(fontSize: AppTheme.fs14, color: Colors.grey[500])),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Text(
                  field.label,
                  style: const TextStyle(fontSize: AppTheme.fs14, color: Colors.white70),
                ),
          ...
          SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(color: Colors.grey[600], fontSize: AppTheme.fs14),
                filled: true,
                fillColor: Colors.white.withOpacity(0.08),
                contentPadding:
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          style: const TextStyle(color: Colors.white, fontSize: AppTheme.fs14),
          isExpanded: true,
