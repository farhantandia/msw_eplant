          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const Text(
                  'MSW ePlant',
                  style: TextStyle(fontSize: AppTheme.fs17, fontWeight: FontWeight.w800, color: AppColors.text),
                ),
                const SizedBox(height: 4),
                Text(
                  'PT Makmur Sejahtera Wisesa\n2\u00D730 MW CFPP + Solar PV',
                  textAlign: TextAlign.center,
                  style: const TextStyle(fontSize: AppTheme.fs16, color: AppColors.textSub, height: 1.5),
                ),
                const SizedBox(height: 36),
                _buildSectionLabel('Sign in as'),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(role.iconData, size: 20, color: color),
                    ),
                  ),
          ...
          if (_errorMessage != null) ...[
            ...
            Row(
              children: [
                ...
                Text(
                  _errorMessage!,
                  style: const TextStyle(fontSize: AppTheme.fs14, color: AppColors.danger),
                ),
              ],
            ),
          ],
